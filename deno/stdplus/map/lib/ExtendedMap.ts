...
export class ExtendedMap<K0, V0> extends Map<K0, V0> {
    ...
    foldl<V1>(f: (v0: V0, v1: V1) => V1, v1: V1): V1 {
        for (const v0 of this.values()) v1 = f(v0, v1); return v1
    }

    foldlWithKey<V1>(f: (k0: K0, v0: V0, b: V1) => V1, v1: V1): V1 {
    ...
    foldMapWithKey<T>(f: (k0: K0, v0: V0) => MonoidInterface<T>, C: new (...ts:T[]) => MonoidInterface<T>) {
        return this.foldlWithKey((k0, v0, m) => m = m.mappend(f(k0, v0)), new C())
    }

    mapWithKey<V1>(f: (k0: K0, v0: V0) => V1): ExtendedMap<K0, V1> {
        return this.foldlWithKey((k0, v0, m1) => m1.set(k0, f(k0, v0)), new ExtendedMap<K0, V1>())
    }
    ...
    groupBy<K1 extends PropertyKey>(f: (v0: V0) => K1 | void): ExtendedMap<K1, V0[]> {
        return this.foldl((v0, b) => (k1 => k1 ? b.set(k1, (v0s => (v0s.push(v0), v0s))(b.get(k1) ?? [])) : b)(f(v0)), new ExtendedMap<K1, V0[]>)
    }
