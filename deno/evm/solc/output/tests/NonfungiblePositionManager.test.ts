...
const edgeCase = 'NonfungiblePositionManager'
const cache = new Cache(fromFileUrl(import.meta.resolve(`../../compile/fixtures`)))
...
Deno.test(`parse ${edgeCase}`, () => { outputSchema.parse(outputString) })